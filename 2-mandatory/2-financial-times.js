/*
    ...
    Implement the function below, which will return a new array containing only article titles which will fit. npm run test
*/
...
function titleWithFewestWords(allArticleTitles) {
  // TODO
  let shortestTitle = allArticleTitles[0]; // The initial value is the first header
...
/**
 * The function filters an array of article titles and returns a new array that contains
 * only those titles that are 65 characters or less.
 */
...
function averageNumberOfCharacters(allArticleTitles) {
  // TODO
  if (!Array.isArray(allArticleTitles) || allArticleTitles.length === 0) {
    return 0; // We return 0 if the input parameter is not an array or the array is empty
  }
